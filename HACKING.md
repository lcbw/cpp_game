...
hidden if the `cpp_navigation_game_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `cpp_navigation_game_DEVELOPER_MODE` to the configure
...
Runs the executable target `cpp_navigation_game_exe`.
